...
export const Faq = () => {
  ...
  <Accordion.Item eventKey="1" className={`${styles.accItem}  mb-3 mb-lg-0 mb-xl-0`}>
  ...
  <Accordion.Item eventKey="2" className={`${styles.accItem} mt-1 mt-lg-0 mt-xl-0`}>
  ...
  <Accordion.Item eventKey="3" className={`${styles.accItem}`}>
    ...
    <Accordion.Body className={`${styles.accbody}`}>
    Waybify is designed to handle a wide range of products, including but not limited to fashion items, 
    electronics, home goods, and personal care products. However, <b> there may be certain restrictions on prohibited 
